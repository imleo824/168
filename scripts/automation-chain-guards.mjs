...
mustHave('crawl main flow', crawl, /config_loaded/);
mustHave('crawl main flow', crawl, /sources_loaded/);
mustHave('crawl main flow', crawl, /source_fetched/);
...
mustHave('interaction panel process events', interactionPanel, /run\?\.processEvents/);
mustHave('interaction panel process events', interactionPanel, /event\?\.message/);
...
mustHave('auto post process log', autoPost, /logInteractionAutomationEvent/);
mustHave('auto post process log', autoPost, /phase: 'run_started'/);
mustHave('auto post process log', autoPost, /phase: 'config_loaded'/);
mustHave('auto post process log', autoPost, /phase: 'topic_selected'/);
mustHave('auto post process log', autoPost, /phase: 'runtime_config_checked'/);
mustHave('auto post process log', autoPost, /phase: 'post_written'/);
mustHave('auto post process log list', autoPost, /attachInteractionAutomationExecutionEvents\('auto_post'/);
...
mustHave('quote publish process log', quote, /logInteractionAutomationEvent/);
mustHave('quote publish process log', quote, /phase: 'run_started'/);
mustHave('quote publish process log', quote, /phase: 'candidates_loaded'/);
mustHave('quote publish process log', quote, /phase: 'candidate_selected'/);
mustHave('quote publish process log', quote, /phase: 'quality_checked'/);
