...
mustHave('main flow config log', crawl, /phase: 'config_loaded'/);
mustHave('main flow sources log', crawl, /phase: 'sources_loaded'/);
mustHave('main flow source group log', crawl, /phase: 'source_group_started'/);
mustHave('main flow source group log', crawl, /phase: 'source_group_finished'/);
mustHave('main flow source fetched log', crawl, /phase: 'source_fetched'/);
mustHave('main flow source fetched log', crawl, /no_new_candidate_after_cursor/);
mustHave('main flow item seen log', crawl, /phase: 'item_seen'/);
mustHave('main flow raw stored log', crawl, /phase: 'raw_stored'/);
mustHave('main flow AI failure log', crawl, /phase: 'ai_failed'/);
mustHave('main flow post write log', crawl, /phase: 'post_db_write_started'/);
...
mustHave('main flow meta fallback details', crawl, /ruleBasedMetaKeys/);
mustHave('main flow meta fallback details', crawl, /ruleBasedFallbackKeys/);
mustHave('main flow contact source audit', crawl, /contactSource: extracted\.audit\.contactSource/);
mustHave('main flow detected contact propagation', crawl, /detectedContact: quality\.contact/);
...
mustHave('auto crawl execution logs bulk details', read('server/services/auto-crawl-execution-log.service.ts'), /listAutoCrawlExecutionLogDetails/);
mustHave('auto crawl routes bulk details', routes, /\/api\/admin\/auto-crawl\/execution-logs\/details/);
mustHave('auto crawl observed lock trace', observedRunner, /createAutoCrawlRun/);
mustHave('auto crawl observed lock trace', observedRunner, /another_instance_running/);
mustHave('auto crawl observed lock trace', observedRunner, /phase: 'lock_not_acquired'/);
mustHave('auto crawl observed lock trace', observedRunner, /createAutoCrawlExecutionLogger/);
mustHave('auto crawl runtime stale diagnosis', read('server/services/auto-crawl-runtime-status.service.ts'), /staleRunningRun/);
mustHave('auto crawl runtime stale diagnosis', read('server/services/auto-crawl-runtime-status.service.ts'), /needsRecovery/);
...
mustHave('AI extraction', crawlAi, /buildRuleBasedCrawlMetaCandidates/);
mustHave('AI extraction', crawlAi, /ruleBasedRawMeta/);
mustHave('AI extraction', crawlAi, /ruleBasedFallbackRawMeta/);
mustHave('AI extraction', crawlAi, /ruleBasedFallbackKeys/);
mustHave('AI extraction', crawlAi, /normalizeCandidateContent/);
mustHave('AI extraction', crawlAi, /quality_cleaned_title_and_content/);
mustHave('AI extraction contact fallback', crawlAi, /contactSource/);
mustHave('AI extraction contact fallback', crawlAi, /detectedContact/);
...
mustHave('AI extraction', crawlAi, /export function buildCrawlMetaSourceData/);
mustHave('AI extraction', crawlAi, /return parts\.join\('\\n'\)\.slice\(0, CANDIDATE_TEXT_LIMIT\)/);
mustHave('AI extraction', crawlAi, /const sourceContent = buildCrawlMetaSourceData\(\{/);
mustHave('AI extraction', crawlAi, /rawTitle: input\.rawTitle/);
...
mustHave('Meta normalization Chinese amount support', crawlMeta, /parseChineseAmounts/);
...
mustHave('Meta normalization boolean string support', crawlMeta, /semantic_boolean/);
mustHave('Meta normalization boolean string support', crawlMeta, /numeric_boolean/);
