...
try {
  await upsertConfig('publish_category_schema', publishCategorySchema);
  await upsertConfig('location_presets', locationPresets);
  console.log('[config] synced publish_category_schema and location_presets');
} finally {
