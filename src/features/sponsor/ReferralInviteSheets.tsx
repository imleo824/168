...
export function ReferralRulesSheet({ summary, onClose }: { summary: ReferralSummary; onClose: () => void }) {
  ...
  return (
    <div className="chat-rules-overlay referral-rules-overlay" role="presentation" onClick={onClose}>
      <section
        className="chat-rules-sheet referral-rules-sheet"
        role="dialog"
        aria-modal="true"
      ...
      >
        ...
        <div className="chat-rules-header">
          ...
          <TopbarIconButton icon={<X aria-hidden="true" />} onClick={onClose} ariaLabel="关闭规则" title="关闭规则" className="chat-rules-close" />
        </div>
        <ul className="chat-rules-list referral-rules-list">
