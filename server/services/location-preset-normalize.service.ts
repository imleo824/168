...
const CITY_ALIASES: Record<string, string[]> = {
  '菲律宾 · 马尼拉': ['manila', 'mnl', 'metro manila', '大马尼拉', '马尼拉大都会', '趴赛', '帕赛', 'pasay', 'bgc', 'makati', '马卡蒂', '马卡提', 'taguig', '塔吉格', 'ortigas', '奥迪加斯', 'quezon', '奎松', 'mandaluyong', '曼达卢永', 'alabang', '阿拉棒', 'pasig', '帕西格', 'paranaque', '帕拉纳克', 'moa', 'aseana', '甲米地', 'cavite'],
  '菲律宾 · 宿务': ['cebu', '宿雾'],
  '菲律宾 · 克拉克': ['clark', '安吉利斯', 'angeles', '天使城', '邦板牙', 'pampanga'],
  '菲律宾 · 达沃': ['davao'],
  '泰国 · 曼谷': ['bangkok', 'bkk', '素坤逸', 'sukhumvit', '辉煌', 'huai khwang', '拉玛九', 'rama 9', '沙吞', 'sathorn', 'silom', '是隆', '暹罗', 'siam'],
  '泰国 · 芭提雅': ['pattaya', '芭堤雅', '中天', 'jomtien'],
  '泰国 · 普吉': ['phuket', '普吉岛', '芭东'],
  '泰国 · 清迈': ['chiang mai', 'chiangmai'],
  '马来西亚 · 吉隆坡': ['kuala lumpur', 'kl', 'klcc', '武吉免登', 'bukit bintang', '满家乐', 'mont kiara'],
  '马来西亚 · 槟城': ['penang'],
  '马来西亚 · 新山': ['johor bahru', 'jb', '柔佛'],
  '阿联酋 · 迪拜': ['dubai', 'dxb', 'db', '国际城', 'international city', 'business bay', '商务港', 'downtown', '市中心', 'marina', 'deira', '德拉', 'silicon oasis', 'jlt'],
  ...
  '缅甸 · 木姐': ['muse'],
  '缅甸 · 大其力': ['tachileik'],
  '柬埔寨 · 金边': ['phnom penh', 'phnompenh', 'pp', '金边市', '桑园区', '堆谷区', 'bkk', '水净华', '钻石岛', '永旺', '金界', 'naga'],
  '柬埔寨 · 西港': ['sihanoukville', 'sihanouk', 'shv', '西哈努克', '西哈努克港', '西哈努克市', '双狮', '南海', '中国城'],
