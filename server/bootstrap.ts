...
const PUBLIC_FEED_CATEGORY_INITIAL_WARM_DELAY_MS = 60_000;
const PUBLIC_FEED_CATEGORY_STEP_DELAY_MS = 15_000;
...
async function startServer() {
  await startServerRuntime(app, {
    ...
    startPublicFeedWarmup: () => startPublicFeedWarmup({
      ...
      categoryInitialDelayMs: PUBLIC_FEED_CATEGORY_INITIAL_WARM_DELAY_MS,
      categoryStepDelayMs: PUBLIC_FEED_CATEGORY_STEP_DELAY_MS,
    }),
  });
}
