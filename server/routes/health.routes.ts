...
const REQUIRED_RUNTIME_COLUMNS = [
  ...
  'PointTransaction.action',
  'PointTransaction.description',
  'PointTransaction.referenceType',
  'PointTransaction.referenceId',
  'PointTransaction.metadata',
  'PointTransaction.userId',
  'PointTransaction.createdAt',
  'ReferralInvite.id',
  'ReferralInvite.userId',
  'ReferralInvite.inviteCode',
  'ReferralInvite.disabledAt',
  'ReferralInvite.createdAt',
  'ReferralInvite.updatedAt',
  'ReferralRelation.id',
  'ReferralRelation.referrerId',
  'ReferralRelation.inviteeId',
  'ReferralRelation.inviteCode',
  'ReferralRelation.source',
  'ReferralRelation.sourceIp',
  'ReferralRelation.sourceUserAgent',
  'ReferralRelation.registeredAt',
  'ReferralRelation.createdAt',
  'ReferralRelation.updatedAt',
] as const;
