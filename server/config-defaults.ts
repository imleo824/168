...
export const DEFAULT_JOB_POSITION_OPTIONS = [
  '客服',
  '推广',
  '电销',
  '运营',
...
export const DEFAULT_JOB_SALARY_RANGE_OPTIONS = [
  '面议',
  '$500 以下',
  '$500 - $800',
  '$800 - $1,200',
...
const DEFAULT_JOB_SALARY_CURRENCY_OPTIONS = [
  'USD',
  'USDT',
  'RMB',
  'CNY',
...
const DEFAULT_JOB_SALARY_PERIOD_OPTIONS = [
  '月薪',
  '日薪',
  '时薪',
  '年薪',
...
export const DEFAULT_SECONDHAND_ITEM_CATEGORY_OPTIONS = [
  '手机',
  '电脑',
  '数码配件',
  '家电',
...
export const DEFAULT_DOCUMENT_SERVICE_TYPE_OPTIONS = [
  '签证',
  '移民',
  '护照',
  '工作证明',
...
export const DEFAULT_NIGHTLIFE_CATEGORY_OPTIONS = [
  'KTV',
  '按摩',
  '开车',
];

export const DEFAULT_RESTAURANT_CATEGORY_OPTIONS = [
  '中餐',
  '火锅',
  '烧烤',
  '日料',
...
export const DEFAULT_SUPPLY_DEMAND_CATEGORY_OPTIONS = [
  '供需',
];
...
export const DEFAULT_PUBLISH_CATEGORY_SCHEMA: PublishCategoryMetaConfig[] = [
  ...
  },
  {
    ...
    name: '招聘',
    fields: [
      { key: 'position', label: '岗位', type: 'select', required: true, options: DEFAULT_JOB_POSITION_OPTIONS },
      { key: 'location', label: '地点', type: 'location', required: true },
      { key: 'salaryRange', label: '薪资', type: 'select', required: true, options: DEFAULT_JOB_SALARY_RANGE_OPTIONS },
      { key: 'salaryCurrency', label: '薪资币种', type: 'select', required: false, options: DEFAULT_JOB_SALARY_CURRENCY_OPTIONS },
      { key: 'salaryUsdMin', label: '美元最低薪资', type: 'number', required: false, min: 0 },
      { key: 'salaryUsdMax', label: '美元最高薪资', type: 'number', required: false, min: 0 },
      { key: 'salaryPeriod', label: '薪资周期', type: 'select', required: false, options: DEFAULT_JOB_SALARY_PERIOD_OPTIONS },
    ],
  },
  {
    slug: 'secondhand',
    name: '二手',
    fields: [
      { key: 'itemCategory', label: '品类', type: 'select', required: true, options: DEFAULT_SECONDHAND_ITEM_CATEGORY_OPTIONS },
      { key: 'location', label: '地点', type: 'location', required: true },
    ],
  },
  {
    ...
    fields: [
      ...
      { key: 'location', label: '地点', type: 'location', required: true },
      { key: 'depositMonths', label: '押几', type: 'number', required: true, min: 0, max: 24 },
  ...
  },
  {
    ...
    fields: [
      { key: 'location', label: '地点', type: 'location', required: true },
      { key: 'serviceType', label: '类型', type: 'select', required: true, options: DEFAULT_DOCUMENT_SERVICE_TYPE_OPTIONS },
    ],
  },
  {
    slug: 'nightlife',
    ...
    fields: [
      { key: 'location', label: '地点', type: 'location', required: true },
      { key: 'serviceType', label: '分类', type: 'select', required: true, options: DEFAULT_NIGHTLIFE_CATEGORY_OPTIONS },
    ],
  },
  {
    slug: 'restaurant',
    ...
    fields: [
      { key: 'location', label: '地点', type: 'location', required: true },
      { key: 'restaurantType', label: '分类', type: 'select', required: true, options: DEFAULT_RESTAURANT_CATEGORY_OPTIONS },
    ],
  },
  {
    slug: 'express',
  ...
  },
  {
    ...
    name: '供需',
    fields: [
      { key: 'supplyDemandType', label: '分类', type: 'select', required: true, options: DEFAULT_SUPPLY_DEMAND_CATEGORY_OPTIONS },
    ],
  },
];
